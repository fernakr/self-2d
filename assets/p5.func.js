  ...
  // Golan's Pattern Master Functions:
    ...
    // =============================================================================
      ...
      p5.ArrayEval.prototype.eval = function(_evalstr, _l1) {
        ...
        var _dest;
        if(multi) _dest = p5.prototype.createArray(_l1, _evalstr.length);
        else _dest = p5.prototype.createArray(_l1);
        // string expansion:
        // u unwraps to 0-1
      ...
      p5.ArrayEval.prototype.eval2d = function(_evalstr, _l1, _l2) {
        ...
        var _dest;
        if(multi) _dest = p5.prototype.createArray(_l1, _l2, _evalstr.length);
        else _dest = p5.prototype.createArray(_l1, _l2);
        // string expansion:
        // u unwraps to 0-1
        // su unwraps to -1 to 1
        // cu unwraps to cell value (0 to dim-1)
      ...
      p5.ArrayEval.prototype.eval3d = function(_evalstr, _l1, _l2, _l3) {
        ...
        var _dest;
        if(multi) _dest = p5.prototype.createArray(_l1, _l2, _l3, _evalstr.length);
        else _dest = p5.prototype.createArray(_l1, _l2, _l3);
        // string expansion:
        // u unwraps to 0-1
        // su unwraps to -1 to 1
        // cu unwraps to cell value (0 to dim-1)
